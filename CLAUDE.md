...
- **AI Models:**
  ...
  - Anthropic Claude Opus 4.7 (document generation via Files API)
...
4. Claude Opus 4.7 wird via `client.beta.messages.create` mit den referenzierten `file_id`s aufgerufen (Betas: `files-api-2025-04-14`).
...
**Document Generation with Claude Opus 4.7:**
```python
uploaded_files = []
...
### Document Generation
- `POST /generate` - Generate legal draft with Claude Opus 4.7 + Files API (rate limit: 10/hour)
