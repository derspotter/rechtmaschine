...
class TestMetaSearch(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_meta_search_orchestration(self):
        ...
        with patch("app.endpoints.research_sources.research_with_grok", new_callable=AsyncMock) as mock_grok, \
             ...
             patch("app.endpoints.research_sources.research_with_openai_search", new_callable=AsyncMock) as mock_openai, \
            ...
            mock_openai.return_value = ResearchResult(query="q", summary="ChatGPT Sum", sources=[{"title": "ChatGPT Source", "url": "http://openai.com"}])
            ...
            mock_aggregator.return_value = ResearchResult(
                ...
                sources=[
                    {"title": "ChatGPT Source", "url": "http://openai.com"},
            ...
            # Verify calls — alle drei Web-Engines laufen im Meta-Sweep
